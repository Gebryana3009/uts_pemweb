...
<html>
    ...
    <?php 
        include "koneksi.php";
        $query = mysqli_query($koneksi,"SELECT * FROM contoh WHERE id_transaksi < 7");
        ?>
            ...
            <?php while ($hasil= mysqli_fetch_array($query, MYSQLI_ASSOC)): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="form_transaksi.php?id=<?php echo $hasil['id_transaksi']; ?>" class="btn btn-primary">Lelang</a>
